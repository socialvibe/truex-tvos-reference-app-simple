...
- (void)stop;
/// callback for ssai ad video playback progress
...
- (nonnull instancetype)initWithProduct:(enum ProductType)product showSkipCardImmediately:(BOOL)showSkipCardImmediately episodeThumbnailImageURI:(NSString * _Nullable)episodeThumbnailImageURI episodeName:(NSString * _Nullable)episodeName interactiveAdTimeRequiredSeconds:(NSInteger)interactiveAdTimeRequiredSeconds skipCardImageURI:(NSString * _Nullable)skipCardImageURI autoAdvanceTimerSeconds:(NSInteger)autoAdvanceTimerSeconds choiceCardBackgroundImageURI:(NSString * _Nullable)choiceCardBackgroundImageURI choiceCardBackgroundVideoURI:(NSString * _Nullable)choiceCardBackgroundVideoURI choiceCardVoiceoverURI:(NSString * _Null_unspecified)choiceCardVoiceoverURI choiceCardInteractButton:(ChoiceCardButton * _Nullable)choiceCardInteractButton choiceCardWatchButton:(ChoiceCardButton * _Nullable)choiceCardWatchButton choiceCardButtonDelayTimeInterval:(NSTimeInterval)choiceCardButtonDelayTimeInterval streamPassRedeemPixelURI:(NSString * _Nullable)streamPassRedeemPixelURI surveyConfigURI:(NSString * _Nullable)surveyConfigURI podIndex:(NSInteger)podIndex trueXURI:(NSString * _Nullable)trueXURI trueXParams:(NSString * _Nullable)trueXParams;
/// Create a Params object configured for a live ad
- (nonnull instancetype)initWithLiveAdSlotStartDate:(NSDate * _Nonnull)liveAdSlotStartDate liveAdDuration:(NSTimeInterval)liveAdDuration;
- (nonnull instancetype)initWithRenderer:(enum Renderer)renderer product:(enum ProductType)product position:(NSString * _Nullable)position showSkipCardImmediately:(BOOL)showSkipCardImmediately episodeThumbnailImageURI:(NSString * _Nullable)episodeThumbnailImageURI episodeName:(NSString * _Nullable)episodeName interactiveAdTimeRequiredSeconds:(NSInteger)interactiveAdTimeRequiredSeconds skipCardImageURI:(NSString * _Nullable)skipCardImageURI autoAdvanceTimerSeconds:(NSInteger)autoAdvanceTimerSeconds choiceCardBackgroundImageURI:(NSString * _Nullable)choiceCardBackgroundImageURI choiceCardBackgroundVideoURI:(NSString * _Nullable)choiceCardBackgroundVideoURI choiceCardVoiceoverURI:(NSString * _Nullable)choiceCardVoiceoverURI choiceCardInteractButton:(ChoiceCardButton * _Nullable)choiceCardInteractButton choiceCardWatchButton:(ChoiceCardButton * _Nullable)choiceCardWatchButton choiceCardButtonDelayTimeInterval:(NSTimeInterval)choiceCardButtonDelayTimeInterval streamPassRedeemPixelURI:(NSString * _Nullable)streamPassRedeemPixelURI surveyConfigURI:(NSString * _Nullable)surveyConfigURI podIndex:(NSInteger)podIndex trueXURI:(NSString * _Nullable)trueXURI trueXParams:(NSString * _Nullable)trueXParams showName:(NSString * _Nullable)showName showGenre:(NSString * _Nullable)showGenre liveAdSlotStartDate:(NSDate * _Nullable)liveAdSlotStartDate liveAdDuration:(NSTimeInterval)liveAdDuration OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, ProductType, closed) {
  ...
  ProductTypeStreamPass = 4,
};

typedef SWIFT_ENUM(NSInteger, Renderer, closed) {
  RendererIRoll = 0,
  RendererTrueX = 1,
  RendererSsai = 2,
  RendererLive = 3,
...
/// Instantiate with an SSAI Ad
+ (id <InnovidAdRenderer> _Nonnull)instantiateSSAIWithAdURI:(NSString * _Nonnull)adURI delegate:(id <InnovidDelegate> _Nullable)delegate showName:(NSString * _Nullable)showName showGenre:(NSString * _Nullable)showGenre SWIFT_WARN_UNUSED_RESULT;
/// Instantiate with an iRoll Ad
+ (id <InnovidAdRenderer> _Nonnull)instantiateWithAdURI:(NSString * _Nonnull)adURI delegate:(id <InnovidDelegate> _Nullable)delegate showName:(NSString * _Nullable)showName showGenre:(NSString * _Nullable)showGenre SWIFT_WARN_UNUSED_RESULT;
/// Instantiate Innovid (support for TrueX 1.3)
/// \param adURI A vast tag uri
///
/// \param params InnovidAdRendererParams
///
/// \param delegate InnovidAdRendererDelegate (will be stored weakly)
///
///
/// returns:
/// an InnovidAdRenderer
+ (id <InnovidAdRenderer> _Nonnull)instantiateWithAdURI:(NSString * _Nonnull)adURI params:(InnovidAdRendererParams * _Nonnull)params delegate:(id <InnovidAdRendererDelegate> _Nonnull)delegate SWIFT_WARN_UNUSED_RESULT;
/// start a TrueX ad
+ (id <InnovidAdRenderer> _Nonnull)instantiateWithAdURI:(NSString * _Nonnull)adURI params:(InnovidAdRendererParams * _Nonnull)params delegate:(id <InnovidAdRendererDelegate> _Nonnull)delegate isAdURIJSON:(BOOL)isAdURIJSON SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// User interaction events
typedef SWIFT_ENUM(NSInteger, InteractionEvent, closed) {
...
typedef SWIFT_ENUM(NSInteger, LifecycleEvent, closed) {
...
typedef SWIFT_ENUM(NSInteger, VideoEvent, closed) {
  VideoEventStart = 0,
/// video started
