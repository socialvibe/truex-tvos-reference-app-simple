...
- (nonnull instancetype)initWithOcAuthMethod:(OCAuthMethod * _Nonnull)authMethod autoReconnect:(BOOL)autoReconnect ocHost:(OCPusherHost * _Nonnull)host port:(NSNumber * _Nullable)port encrypted:(BOOL)encrypted activityTimeout:(NSNumber * _Nullable)activityTimeout;
